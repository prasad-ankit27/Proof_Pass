...
export type ImpureCircuits<PS> = {
  verify_eligibility(context: __compactRuntime.CircuitContext<PS>): Promise<__compactRuntime.CircuitResults<PS, []>>;
...
export type Circuits<PS> = {
  ...
  make_nullifier(context: __compactRuntime.CircuitContext<PS>,
                 student_id_0: Uint8Array): Promise<__compactRuntime.CircuitResults<PS, Uint8Array>>;
  make_issuer_hash(context: __compactRuntime.CircuitContext<PS>,
                   issuer_id_0: Uint8Array): Promise<__compactRuntime.CircuitResults<PS, Uint8Array>>;
}
...
export type Ledger = {
  ...
  readonly requires_python: boolean;
...
export declare class Contract<PS = any, W extends Witnesses<PS> = Witnesses<PS>> {
  ...
  initialState(context: __compactRuntime.ConstructorContext<PS>,
               ...
               expiry_0: bigint,
               claim_limit_0: bigint): Promise<__compactRuntime.ConstructorResult<PS>>;
}
